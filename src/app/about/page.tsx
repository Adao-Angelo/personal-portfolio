export default function About() {
  return (
    <div className="flex flex-col gap-[2.9rem] mt-[7rem] mb-[6rem]">
      <h1 className="font-bold font-sora text-[3.2rem] text-center">
        About Me
      </h1>

      <h2 className="font-bold font-sora text-[2rem]">Quote...</h2>
      <p className="text-[1.6rem]">
        "I believe technology, when combined with passion and persistence, has
      ...
      <h2 className="font-bold font-sora text-[2rem] text-center">Skills</h2>
      <p className="text-[1.6rem]">
        Throughout these years, I have worked immensely to build this arsenal of
        technologies.
      </p>
      <div className="grid gap-[1.5rem] text-[1.6rem]">
      ...
      <p className="text-[1.6rem]">
        I believe that technology is a powerful tool to empower people and bring
        about positive change. I enjoy helping others by simplifying complex
        technical concepts and creating solutions that make their lives easier.
      </p>
      <p className="text-[1.6rem]">
        Beyond development, I enjoy participating in hackathons, contributing to
        open-source projects, and staying updated with the latest advancements
